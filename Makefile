...
$(OBJ_DIR)/NoLista.o: $(INCLUDE_DIR)/NoLista.hpp $(SRC_DIR)/NoLista.cpp
	$(CC) $(CFLAGS) -c $(SRC_DIR)/NoLista.cpp -I$(INCLUDE_DIR) -o $(OBJ_DIR)/NoLista.o

$(OBJ_DIR)/NoPilha.o: $(INCLUDE_DIR)/NoPilha.hpp $(SRC_DIR)/NoPilha.cpp
	$(CC) $(CFLAGS) -c $(SRC_DIR)/NoPilha.cpp -I$(INCLUDE_DIR) -o $(OBJ_DIR)/NoPilha.o

$(OBJ_DIR)/NoFila.o: $(INCLUDE_DIR)/NoFila.hpp $(SRC_DIR)/NoFila.cpp
	$(CC) $(CFLAGS) -c $(SRC_DIR)/NoFila.cpp -I$(INCLUDE_DIR) -o $(OBJ_DIR)/NoFila.o

$(OBJ_DIR)/ListaEncadeada.o: $(INCLUDE_DIR)/NoLista.hpp $(INCLUDE_DIR)/ListaEncadeada.hpp $(SRC_DIR)/ListaEncadeada.cpp
	$(CC) $(CFLAGS) -c $(SRC_DIR)/ListaEncadeada.cpp -I$(INCLUDE_DIR) -o $(OBJ_DIR)/ListaEncadeada.o

$(OBJ_DIR)/Pilha.o: $(INCLUDE_DIR)/NoPilha.hpp $(INCLUDE_DIR)/Pilha.hpp $(SRC_DIR)/Pilha.cpp
	$(CC) $(CFLAGS) -c $(SRC_DIR)/Pilha.cpp -I$(INCLUDE_DIR) -o $(OBJ_DIR)/Pilha.o

$(OBJ_DIR)/Fila.o: $(INCLUDE_DIR)/NoFila.hpp $(INCLUDE_DIR)/Fila.hpp $(SRC_DIR)/Fila.cpp
...
$(OBJ_DIR)/main.o: $(INCLUDE_DIR)/Grafo.hpp $(INCLUDE_DIR)/Escalonador.hpp $(INCLUDE_DIR)/NoLista.hpp $(INCLUDE_DIR)/Fila.hpp $(SRC_DIR)/main.cpp
